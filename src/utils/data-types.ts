...
const STRING = [
  ...
  'character varying', 'varying character', 'char varying', 'nvarchar', 'national varchar',
  'character', 'native character', 'varchar', 'char', 'nchar', 'national char', 'varchar2',
...
function extend(types: Array<string>, dataType: PropertyType): void {
  for (const t of types) { DATA_TYPES[t] = dataType }
}
